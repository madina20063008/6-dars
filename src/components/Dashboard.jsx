...
//                     <li className='flex gap-2 text-red-500 mt-[40px]'><img src={logout} alt="" className='w-7' />Log out</li>
//                 </ul>
//                 <div>
        ...
        <div>
            <div className="w-[1100px] mx-auto mt-[120px] flex gap-[100px]">
                <ul className='text-[18px] p-4 bg-[#FBFBFB] w-[250px]'>
                    ...
                    <li className='flex gap-2 text-red-500 mt-[40px] cursor-pointer' onClick={handleLogout}>
